...
<body>
        <table class="border-bottom">
            <tr>
                ...
                <td class="text-right">
                    <h1 class="text-right">COTIZACIÓN</h1>

                        <p class=""><strong>Nro. 000{{ $cotizacion->id }}</strong></p>
                        <p class="text-size">Fecha: {{ $cotizacion->created_at}}</p>
    ...
    <div>
        ...
        <table class="">
            ...
            <tr style="padding: 3px">
                ...
                <td style="padding: 3px" class=""><strong>: </strong> {{ $cotizacion->requerimiento }}</td>
            </tr>
            <tr style="padding: 3px">
                <td style="padding: 3px" class=""><strong>Ubicación</strong></td>
                <td style="padding: 3px" class=""><strong>: </strong> {{ $cotizacion->ubicacion }}</td>
            </tr>
            <tr style="padding: 3px">
                <td style="padding: 3px" class=""><strong>Dep. Prov. Dist.</strong></td>
                <td style="padding: 3px" class=""> <strong>: </strong>{{ $cotizacion->departamento }}/{{ $cotizacion->provincia }}/{{ $cotizacion->distrito }}</td>
            </tr>
        </table>
    </br>
        ...
        <table >
            ...
            <tbody >
                ...
                <tr >
                    ...
                    <p>{{ $productos->find($detalle->productoid)->descripcion }}</p></td>
                ...
                <tr class="border-top">
                    ...
                    <td >Sub Total</td>
                    <td class=" text-right">S/. {{ number_format( $cotizacion->total, 2) }}</td>
                </tr>
                <tr >

                    <td >Descuento</td>
                    <td class="text-right">S/.  {{ number_format($cotizacion->descuento, 2) }}</td>
                </tr>
                <tr >

                    <td ><strong>Total</strong></td>
                    <td class="text-right"><strong> S/.  {{ number_format($cotizacion->total - $cotizacion->descuento, 2) }}</strong></td>
                </tr>
            </tbody>
        </table>
    </br>
